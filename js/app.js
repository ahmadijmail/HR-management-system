...
function Person(EmployeeID, FullName, Department, Level, image_URL) {
...
console.log(Min,Max);
  ...
  let salary = randomSalary - randomSalary * (7.5 / 100);
...
function clicko(event) {
  ...
  //let salary = Person.prototype.findSalary(Level);
//   console.log(salary);
...
function getdata() {
  ...
  } else {let GhaziSamer = new Person(
    1000,
    "Ghazi Samer",
    "Administration",
    "Senior",
